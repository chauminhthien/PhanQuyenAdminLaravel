...
<html class=" ">
    <head>
        ...
        <link href="TT_Admin/assets/plugins/icheck/skins/all.css" rel="stylesheet" type="text/css" media="screen"/>
    ...
    <body class=" login_page">
            ...
            <div class="login-wrapper row">
                <div id="login" class="login loginpage col-lg-offset-4 col-md-offset-3 col-sm-offset-3 col-xs-offset-0 col-xs-12 col-sm-6 col-lg-4">
                    <h1><a href="#" title="Login Page" tabindex="-1">Complete Admin</a></h1>
                        ...
                        @endif
                    <form name="loginform" id="loginform" action="../admin/dang-nhap" method="post">
                        <p>
                            <label for="user_login">Username<br />
                            <input type="text" name="email" id="user_login" placeholder="Username" class="input" value="" size="20" /></label>
                        </p>
                        <p>
                            <label for="user_pass">Password<br />
                            <input type="password" name="password" id="user_pass" placeholder="******************" class="input" value="" size="20" /></label>
                        </p>
        ...
        <!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - START --> 
        <script src="TT_Admin/assets/plugins/icheck/icheck.min.js" type="text/javascript"></script>
        <!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - END --> 
